...
if ($chat_type == "private") {
    ...
    if (in_array($from_id, $admins)) {
        ...
        if ($text == '/start') {
            $reply = '❗️کاربر گرامی برای مطلع شدن از شرایط عضویت در کانال های خصوصی Iɴғɪɴɪᴛʏ Pᴀᴄᴋᴀɢᴇ میبایست در مرحله اول ثبت نام در ربات انجام داده تا نهایتا شرایط و قوانین عضویت برای شما ارسال شود به همین منظور میبایست شماره اکانت و موقعیت مکانی خود را برای ربات ارسال نمایید .
