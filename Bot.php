...
⚠️ دقت داشته باشید اگر از شماره مجازی استفاده میکنید ربات شما را بصورت خودکار حذف خواهد کرد میبایست شماره ایران تهیه و مجددا اقدام نمایید .';
...
📌 کانال دوم : مخصوص پکیج های آموزشی از سایت های معروف و در هر زمینه ای از علوم کامپیوتر را فرا میگیرد و لازم به ذکر است آموزش هایی که در سطح اینترنت پخش شده و نیز آموزش هایی که هنوز پابلیک نشده را دارا میباشد و شما را از خرید هر گونه آموزش در سطح اینترنت بی نیاز میکند .
🔗 Link: https://t.me/InfinityPackage/46

💳 شرایط عضویت : پرداخت هزینه دویست هزار تومان برای عضویت مادام در کانال های خصوصی دریافت میشود بعد از پرداخت مبلغ عضویت ، یک عکس از کارت پرداختی خود به گونه ای که فقط شماره کارت و اسم فامیل شما دیده شود در قسمت ارتباط با ادمین برای ربات ارسال کنید و منتظر دریافت لینک های کانال خصوصی باشید (علت درخواست عکس از کارت این است که افراد سودجو با استفاده از اطلاعات حساب های دزدی در درگاه زرین پال ما پرداخت انجام ندهند) . 
...
📣 ادمین های ربات هر چهار ساعت یکبار ربات را چک میکنند لطفا در دریافت پاسخ صبور باشید .

📣 اگر مطالب کانال به هر نحوی نشر داده شود آن شخص شناسایی شده و از کانال ها ی خصوصی برای همیشه حذف خواهد شد لازم به ذکر است ارسال محتوا کانال در فضای ابری (Save Message) موردی نخواهد داشت .
...
💰🌐 درگاه پرداخت ایمن ZarinPal :
https://zarinp.al/334458';
            send_reply(
                'sendMessage',
                [
                    'chat_id' => $chat_id,
            ...
            if (file_get_contents("data/$from_id/contact_us.txt") != 1) {
                $reply = "‼️ کاربر گرامی دستور نامعتبر میباشد";
                send_reply(
                    'sendMessage',
                    [
                        'chat_id' => $chat_id,
                ...
                $reply = "⏳ پیام شما به ادمین ربات ارسال گردید لطفا تا دریافت پاسخ صبور باشید";
                send_reply(
                    'sendMessage',
                    [
                        'chat_id' => $chat_id,
